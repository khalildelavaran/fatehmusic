...
export function buildSEO({
    ...
    const candidates = linkCandidates ?? buildSiteLinkCandidates(site);
    const links = buildInternalLinkPlan({
        currentUrl: canonicalUrl,
        currentTopics: topicsResolved.map((topic) => topic.slug),
    ...
    return Object.freeze({
        ...
        twitter,
        schemaGraph,
        geo: Object.freeze({ topics: topicsResolved, intent, freshness, internalLinks: links, answerBlocks: answers, audit })
    });
}
