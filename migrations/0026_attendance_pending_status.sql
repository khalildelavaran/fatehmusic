...
CREATE TABLE enrollment_sessions_v2 (
  ...
  makeup_for_id         INTEGER REFERENCES enrollment_sessions_v2(id),
...
INSERT INTO enrollment_sessions_v2
  (id, enrollment_id, session_id, status, attendance_mode, makeup_for_id, note, created_at, updated_at)
SELECT
  id, enrollment_id, session_id, status, attendance_mode, NULL, note, created_at, updated_at
